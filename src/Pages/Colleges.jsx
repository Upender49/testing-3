...
// Make sure this path points correctly to your JSON file
  ...
  return (
    <div className="bg-slate-100 min-h-screen p-6 sm:p-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-extrabold text-slate-800 tracking-tight">Colleges Directory</h1>
          <p className="text-slate-400 text-sm mt-1">Explore top institutions across Telangana</p>
        </div>
              ...
              >
                ...
                <div className="relative h-28 bg-linear-to-br from-amber-100 to-orange-100 overflow-hidden flex items-center justify-center">
                  <span className="absolute top-2 right-2 bg-blue-500 text-white text-[10px] font-bold px-2.5 py-0.5 rounded-full shadow-md z-20">
                    {/* Fallback to "Institute" if you don't have a 'type' property in your JSON */}
                    {college.type || "Institute"} 
                  </span>
                  
                  {/* Using college.image as the main campus background */}
                  <img 
                    src={college.image} 
                    alt={college.name} 
                ...
                <div className="px-2.5 py-2">
                  <div className="flex items-center gap-1.5">
                    ...
                    {/* Using college.logo if you add it to JSON later, otherwise falling back to the standard college.image */}
                    <img 
