...
export function TeacherSidebar() {
    ...
    return (
        <div className="bg-gray-50 flex flex-col h-[100dvh] overflow-hidden font-body">
            {/* --- TOP HEADER --- */}
            ...
            <div className="flex flex-1 overflow-hidden relative">
                ...
                {/* --- SIDEBAR CONTAINER --- */}
                <aside id="sidebar" className={`bg-[#012029] text-white h-full flex flex-col transition-all duration-300 ease-in-out z-30 shadow-2xl flex-shrink-0 absolute lg:relative group/sidebar w-[15rem] ${isSidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"} ${isSidebarCollapsed ? "sidebar-collapsed !w-20" : ""}`}>
                    ...
                    {/* --- NAVIGATION MENU --- */}
                    <nav className="flex-1 overflow-y-auto sm:group-[.sidebar-collapsed]/sidebar:overflow-y-visible [&::-webkit-scrollbar]:w-[4px] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-white/20 [&::-webkit-scrollbar-thumb]:rounded-[4px] hover:[&::-webkit-scrollbar-thumb]:bg-white/40 py-4 flex flex-col gap-1.5 relative overflow-x-hidden">

                        {/* Teacher Dashboard */}
                        <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("teacher-dashboard"); }} className={`menu-link flex items-center gap-3 py-3 group-[.sidebar-collapsed]/sidebar:py-2 px-4 transition-all duration-300 ease-out hover:bg-white/[0.08] hover:brightness-110 text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center ${activeMenu === "teacher-dashboard" ? "bg-white/[0.08] brightness-110" : ""}`}>
                        ...
                        <div className="relative border-t border-white/20">
                            <button onClick={() => handleDropdownClick("profile")} className="w-full flex items-center justify-between py-3 group-[.sidebar-collapsed]/sidebar:py-2 px-4 transition-all duration-300 ease-out hover:bg-white/[0.08] focus:bg-white/[0.08] text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                        ...
                        <div className="relative border-t border-white/20">
                            <button onClick={() => handleDropdownClick("academic")} className="w-full flex items-center justify-between py-3 group-[.sidebar-collapsed]/sidebar:py-2 px-4 transition-all duration-300 ease-out hover:bg-white/[0.08] focus:bg-white/[0.08] text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                                <div className="flex items-center gap-3 group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0">
                                    <div className="flex-col flex items-center justify-center">
                                ...
                                <ChevronDown className={`w-4 h-4 transition-transform duration-300 group-[.sidebar-collapsed]/sidebar:hidden chevron-icon mr-4 ${openDropdown === "academic" ? "rotate-0" : "rotate-180"}`} />
                            ...
                            <div className={`dropdown-menu flex-col gap-1 overflow-hidden transition-all duration-300 group-[.sidebar-collapsed]/sidebar:!hidden pl-6 ${openDropdown === "academic" ? "flex" : "hidden"}`}>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("academic-overview"); }} className={getSubMenuLinkClass("academic-overview")}>
                                    <BookOpen className="w-4 h-4 text-emerald-300" />
                                    <span className="nav-text font-medium text-sm whitespace-nowrap">Academic Overview</span>
                                </a>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("mark-attendance"); }} className={getSubMenuLinkClass("mark-attendance")}>
                                ...
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("assignments-review"); }} className={getSubMenuLinkClass("assignments-review")}>
                                    <FileCheck className="w-4 h-4 text-emerald-300" />
                                    <span className="nav-text font-medium text-sm whitespace-nowrap">Assignments Review</span>
                                </a>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("upload-resources"); }} className={getSubMenuLinkClass("upload-resources")}>
                                ...
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("results-management"); }} className={getSubMenuLinkClass("results-management")}>
                        ...
                        <div className="relative border-t border-white/20">
                            <button onClick={() => handleDropdownClick("support")} className="w-full flex items-center justify-between py-3 group-[.sidebar-collapsed]/sidebar:py-2 px-4 transition-all duration-300 ease-out hover:bg-white/[0.08] focus:bg-white/[0.08] text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                                <div className="flex items-center gap-3 group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0">
                                    <div className="flex-col flex items-center justify-center">
                                ...
                                <ChevronDown className={`w-4 h-4 transition-transform duration-300 group-[.sidebar-collapsed]/sidebar:hidden chevron-icon mr-4 ${openDropdown === "support" ? "rotate-0" : "rotate-180"}`} />
                            ...
                            <div className={`dropdown-menu flex-col gap-1 overflow-hidden transition-all duration-300 group-[.sidebar-collapsed]/sidebar:!hidden pl-6 ${openDropdown === "support" ? "flex" : "hidden"}`}>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("mentorship"); }} className={getSubMenuLinkClass("mentorship")}>
                        ...
                        <div className="relative border-t border-white/20">
                            <button onClick={() => handleDropdownClick("announcements")} className="w-full flex items-center justify-between py-3 group-[.sidebar-collapsed]/sidebar:py-2 px-4 transition-all duration-300 ease-out hover:bg-white/[0.08] focus:bg-white/[0.08] text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                                <div className="flex items-center gap-3 group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0">
                                    <div className="flex-col flex items-center justify-center">
                            ...
                            <div className={`dropdown-menu flex-col gap-1 overflow-hidden transition-all duration-300 group-[.sidebar-collapsed]/sidebar:!hidden pl-6 ${openDropdown === "announcements" ? "flex" : "hidden"}`}>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("teacher-circulars"); }} className={getSubMenuLinkClass("teacher-circulars")}>
                                    <Bell className="w-4 h-4 text-amber-300" />
                                    <span className="nav-text font-medium text-sm whitespace-nowrap">Circulars & Notifications</span>
                                </a>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("teacher-calendar"); }} className={getSubMenuLinkClass("teacher-calendar")}>
                                    <Calendar className="w-4 h-4 text-amber-300" />
                                    <span className="nav-text font-medium text-sm whitespace-nowrap">Academic Calendar</span>
                                </a>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("events-coordination"); }} className={getSubMenuLinkClass("events-coordination")}>
                        ...
                        {/* Requests Dropdown */}
                        <div className="relative border-t border-white/20">
                            <button onClick={() => handleDropdownClick("requests")} className="w-full flex items-center justify-between py-3 group-[.sidebar-collapsed]/sidebar:py-2 px-4 transition-all duration-300 ease-out hover:bg-white/[0.08] focus:bg-white/[0.08] text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                                <div className="flex items-center gap-3 group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0">
                                    <div className="flex-col flex items-center justify-center">
                            ...
                            <div className={`dropdown-menu flex-col gap-1 overflow-hidden transition-all duration-300 group-[.sidebar-collapsed]/sidebar:!hidden pl-6 ${openDropdown === "requests" ? "flex" : "hidden"}`}>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("request-access"); }} className={getSubMenuLinkClass("request-access")}>
                                ...
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("leaves-approval"); }} className={getSubMenuLinkClass("leaves-approval")}>
                        ...
                        <div className="relative border-t border-white/20">
                            <button onClick={() => handleDropdownClick("services")} className="w-full flex items-center justify-between py-3 group-[.sidebar-collapsed]/sidebar:py-2 px-4 transition-all duration-300 ease-out hover:bg-white/[0.08] focus:bg-white/[0.08] text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                                <div className="flex items-center gap-3 group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0">
                                    <div className="flex-col flex items-center justify-center">
                            ...
                            <div className={`dropdown-menu flex-col gap-1 overflow-hidden transition-all duration-300 group-[.sidebar-collapsed]/sidebar:!hidden pl-6 ${openDropdown === "services" ? "flex" : "hidden"}`}>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("salary-payroll"); }} className={getSubMenuLinkClass("salary-payroll")}>
                                ...
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("teacher-transport"); }} className={getSubMenuLinkClass("teacher-transport")}>
                    ...
                    <div className="p-2 group-[.sidebar-collapsed]/sidebar:pb-12 border-t border-white/20 shrink-0 relative z-50">
                        {/* Change Password */}
                        <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("password"); }} className={`flex items-center gap-3 px-3 py-2.5 group-[.sidebar-collapsed]/sidebar:py-2 mx-2 group-[.sidebar-collapsed]/sidebar:mx-0 rounded-xl transition-all duration-300 ease-out hover:bg-amber-500 hover:shadow-lg text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center ${activeMenu === "password" ? "bg-amber-500 shadow-lg" : ""}`}>
                            <div className="flex-col flex items-center justify-center">
                        ...
                        {/* Sign Out */}
                        <a href="#" className="flex mt-1 items-center gap-3 px-3 py-2.5 group-[.sidebar-collapsed]/sidebar:py-2 mx-2 group-[.sidebar-collapsed]/sidebar:mx-0 rounded-xl transition-all duration-300 ease-out hover:bg-red-500/80 text-white hover:text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                            <div className="flex-col flex items-center justify-center">
