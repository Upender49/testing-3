        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="reveal">
              ...
              <p className="text-slate-600 text-base md:text-lg font-body font-light max-w-xl leading-relaxed mb-8">
                CampusIQ unifies attendance, faculty workflows, exams, and
                real-time communication into a single, secure web platform
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 text-white">
                <a
                  href="#services"
                  className="btn-primary px-3 py-2 rounded-xl text-base flex items-center gap-2"
                >
                ...
                <a
                  href="#ai"
                  className="btn-outline px-3 py-2 rounded-xl text-base flex items-center gap-2"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
                ...
                <div className="flex items-end gap-1.5">
                  ...
                  <div className="flex flex-col mb-1.5">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M12 7l-4 4-2-2a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l5-5a1 1 0 10-1.414-1.414z"
                        clipRule="evenodd"
                      />
                    </svg>
                  </div>
          ...
          <div className="mt-20 pt-16 border-t border-slate-100 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-6xl mx-auto reveal">
            <div className="stat-card">
              <p className="font-heading font-extrabold text-4xl linear-text">
                3
              </p>
              <p className="text-slate-500 text-[11px] font-body uppercase tracking-wider mt-1">
                User Roles
              </p>
            </div>
            <div className="stat-card">
      ...
      <section id="roles" className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="text-center mb-16 reveal">
            ...
            <h2 className="font-heading font-bold text-4xl md:text-5xl text-slate-900 mb-5">
              Three Portals. One System.
            </h2>
            <p className="text-slate-600 font-body max-w-xl mx-auto text-lg">
              Every stakeholder gets a purpose-built experience — tailored
              access, relevant data, and streamlined workflows.
            </p>
          </div>
              ...
              <div className="p-8">
                <div className="flex items-center justify-between mb-6">
                  <div className="w-20 h-20 rounded-2xl icon-wrap overflow-hidden p-2">
                    <img
                      src="services_student.png"
                      alt="Student Icon"
                      className="w-full h-full "
                    />
                  </div>
                  <span className="role-student text-[10px] font-heading font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                    For Students
                  </span>
                </div>
                ...
                <p className="text-slate-600 font-body text-sm leading-relaxed mb-6">
                  Your entire college life, digitally organized. Access
                  everything you need — from attendance to assignments — in one
                  clean, personal dashboard.
                </p>
                <ul className="space-y-2.5 text-sm font-body text-slate-600">
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 shrink-0"></span>
                    Personal profile & academic records
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 shrink-0"></span>
                    Attendance, results & exam registration
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 shrink-0"></span>
                    Circulars, events & academic calendar
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 shrink-0"></span>
                    Fee overview, transport & document requests
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 shrink-0"></span>
                    Discussion forum & faculty chat
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="p-8">
                <div className="flex items-center justify-between mb-6">
                  <div className="w-16 h-16 rounded-2xl icon-wrap overflow-hidden p-2">
                    <img
                      src="services_faculty.jpg"
                      alt="Faculty Icon"
                      className="w-full h-full object-contain"
                    />
                  </div>
                  <span className="role-faculty text-[10px] font-heading font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                    For Faculty
                  </span>
                </div>
                <h3 className="font-heading font-bold text-xl text-slate-900 mb-3">
                ...
                <p className="text-slate-600 font-body text-sm leading-relaxed mb-6">
                  Teach smarter, manage easier. A dedicated workspace for
                  managing classes, tracking student progress, and fulfilling
                  academic responsibilities efficiently.
                </p>
                <ul className="space-y-2.5 text-sm font-body text-slate-600">
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-amber-400 shrink-0"></span>
                    Attendance creation, marking & management
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-amber-400 shrink-0"></span>
                    Upload internal marks & generate reports
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-amber-400 shrink-0"></span>
                    Assigned class overview & timetable
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-amber-400 shrink-0"></span>
                    Create timed exams & upload assignments
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-amber-400 shrink-0"></span>
                    Student remarks, mentoring & secure chat
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="card-base rounded-3xl overflow-hidden reveal reveal-delay-4">
              ...
              <div className="p-8">
                <div className="flex items-center justify-between mb-6">
                  <div className="w-16 h-16 rounded-2xl icon-wrap overflow-hidden p-2">
                    <img
                      src="services_admin.png"
                      alt="Admin Icon"
                      className="w-full h-full object-contain"
                    />
                  </div>
                  <span className="role-admin text-[10px] font-heading font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                    For Administrators
                  </span>
                </div>
                <h3 className="font-heading font-bold text-xl text-slate-900 mb-3">
                ...
                <p className="text-slate-600 font-body text-sm leading-relaxed mb-6">
                  Complete institutional control at your fingertips. Manage
                  users, structure academics, monitor activity, and broadcast
                  information — all from one secure panel.
                </p>
                <ul className="space-y-2.5 text-sm font-body text-slate-600">
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-violet-400 shrink-0"></span>
                    Add, update, manage all users & roles
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-violet-400 shrink-0"></span>
                    Timetables, exam scheduling & result upload
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-violet-400 shrink-0"></span>
                    Publish circulars & broadcast announcements
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-violet-400 shrink-0"></span>
                    Fee structure definition & due monitoring
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-violet-400 shrink-0"></span>
                    Chat moderation & activity audit logs
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section id="services" className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="text-center mb-16 reveal">
            ...
            <h2 className="font-heading font-bold text-4xl md:text-5xl text-slate-900 mb-5">
              What CampusIQ Does for You
            </h2>
            <p className="text-slate-600 font-body max-w-2xl mx-auto text-lg">
              Six powerful service pillars that cover the complete operational
              lifecycle of a college — from classroom to administration.
            </p>
          </div>
          ...
          <div className="space-y-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center relative z-10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 font-body text-sm mb-4">
                    Eliminate paperwork with digital session marking, automated
                    percentage calculations, and instant low-attendance alerts
                    for students.
                  </p>
            ...
            <div className="card-base rounded-3xl p-6 lg:p-8 reveal border-l-[3px] border-l-violet-400 bg-linear-to-r from-violet-50/40 to-white">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center relative z-10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 font-body text-sm mb-4">
                    Complete exam lifecycle management from scheduling and
                    registration to automated result publication and progress
                    tracking.
                  </p>
                  <div className="flex flex-wrap gap-2">
            ...
            <div className="card-base rounded-3xl p-6 lg:p-8 reveal border-l-[3px] border-l-amber-400 bg-linear-to-r from-amber-50/40 to-white">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center relative z-10">
                <div className="w-32 h-32 rounded-3xl bg-slate-50/80 border border-slate-100 shadow-sm shadow-brand-100/20 overflow-hidden shrink-0 flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
                  <img
                    src="services_circulars.webp"
                    alt="Circulars & Notifications"
                    className="w-full h-full"
                  />
                </div>
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 font-body text-sm mb-4">
                    Instant official communication for events, exams, and
                    notices directly to every stakeholder's dashboard.
                  </p>
                  <div className="flex flex-wrap gap-2">
            ...
            <div className="card-base rounded-3xl p-6 lg:p-8 reveal border-l-[3px] border-l-brand-400 bg-linear-to-r from-brand-50/40 to-white">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center relative z-10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 font-body text-sm mb-4">
                    Secure, privacy-first messaging for faculty and students
            ...
            <div className="card-base rounded-3xl p-6 lg:p-8 reveal border-l-[3px] border-l-rose-400 bg-linear-to-r from-rose-50/40 to-white">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center relative z-10">
                <div className="w-32 h-32 rounded-3xl bg-slate-50/80 border border-slate-100 shadow-sm shadow-brand-100/20 overflow-hidden shrink-0 flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
                  <img
                    src="services_discussion.jpg"
                    alt="Student Discussion Forum"
                    className="w-full h-full"
                  />
                </div>
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 font-body text-sm mb-4">
                    A moderated community space for Doubts, academic
                    collaboration, and placement preparation.
                  </p>
                  <div className="flex flex-wrap gap-2">
            ...
            <div className="card-base rounded-3xl p-6 lg:p-8 reveal border-l-[3px] border-l-teal-400 bg-linear-to-r from-teal-50/40 to-white">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center relative z-10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 font-body text-sm mb-4">
                    Paperless portal for credential uploads and official
                    document requests with real-time status tracking.
                  </p>
                  <div className="flex flex-wrap gap-2">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="reveal">
              ...
              <p className="text-slate-600 font-body leading-relaxed mb-8 text-lg">
                The most powerful feature of the platform — an intelligent
                chatbot powered by Google Gemini AI, trained specifically on
                your college's data. It provides instant, accurate answers to
                common queries around the clock, dramatically reducing
                dependency on office staff and manual processes.
              </p>
              ...
              <div className="space-y-4 mb-10">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 font-body text-sm">
                      Instantly know any faculty's cabin number, department,
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 font-body text-sm">
                      Get upcoming exam dates, today's class schedule, and
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 font-body text-sm">
                      Find any classroom, block, lab, or facility location
                      across the campus instantly.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <p className="font-heading font-semibold text-slate-900 text-sm">
                      College Rules & Circulars
                    </p>
                    <p className="text-slate-600 font-body text-sm">
                      Ask about regulations, recent circulars, attendance
                      policies, and event details at any time.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-brand-50/50 border border-brand-100/50">
                ...
                <p className="text-slate-700 font-body text-sm">
                  <span className="text-brand-700 font-semibold">Impact:</span>{" "}
                  Reduces repetitive office queries by over 70%, frees staff for
                  higher-value work, and provides students immediate help 24/7.
                </p>
              </div>
            </div>
              ...
              <div className="rounded-3xl overflow-hidden bg-slate-50 border border-brand-200/50 shadow-2xl shadow-brand-100/20">
                <div className="bg-linear-to-r from-brand-600 to-brand-500 px-6 py-4 flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-brand-50 text-[10px] font-body">
                ...
                <div className="p-6 space-y-4 min-h-72">
                  ...
                  <div className="flex justify-end">
                    <div className="bubble-bot rounded-2xl rounded-tr-sm px-4 py-3 max-w-sm">
                      <p className="text-sm font-body text-brand-900">
                        Mid-semester exams for CSE are scheduled from{" "}
                        <strong className="text-brand-950 font-bold">
                          March 10 – 18, 2025
                        </strong>
                        . Your full exam schedule is also available in your
                        portal dashboard.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-end">
                    <div className="bubble-bot rounded-2xl rounded-tr-sm px-4 py-3 max-w-sm">
                      <p className="text-sm font-body text-brand-900">
                        Today (Thursday) you have:{" "}
                        <strong className="text-brand-950 font-bold">
                          DBMS at 9am (Block B-301)
                        </strong>
                        ,{" "}
                        <strong className="text-brand-950 font-bold">
                          OS Lab at 11am (Lab 102)
                        </strong>
                        , and{" "}
                        <strong className="text-brand-950 font-bold">
                          CN at 2pm (Block A-105)
                        </strong>
                        .
                      </p>
                    </div>
                ...
                <div className="border-t px-5 py-4 flex items-center gap-3 border-slate-100">
                  <div className="flex-1 flex items-center gap-2 rounded-xl px-4 py-2.5 bg-slate-50 border border-slate-200">
                    <input
                      ...
                      className="bg-transparent flex-1 text-sm font-body text-slate-900 placeholder-slate-400 focus:outline-none"
                    />
                  </div>
      ...
      <section id="pricing" className="py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="text-center mb-16 reveal">
            ...
            <p className="text-slate-600 font-body max-w-2xl mx-auto text-lg">
              Choose the perfect tier to modernize your campus operations and
          ...
          <div className="grid md:grid-cols-3 gap-8 items-stretch">
            <div className="card-base plan-basic rounded-4xl p-8 flex flex-col reveal">
              <div className="mb-8">
                ...
                <p className="text-slate-500 font-body text-sm">
                  Essential digital tools for small colleges looking to start
              ...
              <button className="btn-outline w-full py-4 rounded-xl text-sm">
                Start Basic
              </button>
            </div>
            ...
            <div className="card-base plan-pro rounded-4xl p-8 flex flex-col reveal reveal-delay-2 scale-105 z-10 border-brand-400 shadow-2xl">
              <div className="absolute top-6 right-8">
                <span className="bg-brand-600 text-white text-[10px] font-heading font-bold px-3 py-1.5 rounded-full uppercase tracking-widest shadow-md">
                  Most Popular
                </span>
              </div>
              <div className="mb-8">
                <div className="w-12 h-12 rounded-2xl icon-indigo flex items-center justify-center mb-6">
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    <path d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-7.714 2.143L11 21l-2.143-7.714L1 12l7.714-2.143L11 3z" />
                  </svg>
                </div>
                <h3 className="font-heading font-bold text-xl text-slate-900 mb-2">
                  Pro
                ...
                <p className="text-slate-500 font-body text-sm">
                  The sweet spot for growing campuses needing AI automation.
                </p>
              </div>
              <div className="mb-8">
                <span className="text-5xl font-heading font-extrabold text-brand-600">
                  $499
                </span>
                <span className="text-slate-500 text-sm font-body">/month</span>
              </div>
              ...
              <button className="btn-primary w-full py-4 rounded-xl text-sm shadow-xl">
                Upgrade to Pro
              </button>
            </div>
            ...
            <div className="card-base plan-premium rounded-4xl p-8 flex flex-col reveal reveal-delay-4 border-amber-300 shadow-amber-50">
              <div className="mb-8">
                ...
                <p className="text-slate-500 font-body text-sm">
                  Full enterprise suite for large universities and multi-campus
                  setups.
                </p>
              </div>
              <div className="mb-8">
                <span className="text-5xl font-heading font-extrabold text-amber-600">
                  $999
                </span>
                <span className="text-slate-500 text-sm font-body">/month</span>
              </div>
              ...
              <button className="bg-amber-600 hover:bg-amber-700 text-white font-heading font-semibold py-4 rounded-xl text-sm transition-all shadow-lg shadow-amber-200">
                Go Premium
              </button>
            </div>
          </div>
