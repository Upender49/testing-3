    ...
    return (
        <div className="bg-gray-50 flex flex-col h-dvh overflow-hidden font-body">
            ...
            <div className="flex flex-1 overflow-hidden relative">
                ...
                {/* --- SIDEBAR CONTAINER --- */}
                <aside id="sidebar" className={`bg-[#100636] text-white h-full flex flex-col transition-all duration-300 ease-in-out z-30 shadow-2xl shrink-0 absolute lg:relative group/sidebar w-60 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"} ${isSidebarCollapsed ? "sidebar-collapsed w-20!" : ""}`}>
                    ...
                    <nav className="flex-1 overflow-y-auto sm:group-[.sidebar-collapsed]/sidebar:overflow-y-visible [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-white/20 [&::-webkit-scrollbar-thumb]:rounded-sm hover:[&::-webkit-scrollbar-thumb]:bg-white/40 py-4 flex flex-col gap-1.5 relative overflow-x-hidden">
                        ...
                        <div className="relative border-t border-white/20">
                            <button onClick={() => handleDropdownClick("access")} className="w-full flex items-center justify-between py-3 px-4 transition-all duration-300 ease-out hover:bg-white/8 focus:bg-white/8 text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                                ...
                                <ChevronDown className={`w-4 h-4 transition-transform duration-300 group-[.sidebar-collapsed]/sidebar:hidden chevron-icon mr-4 ${openDropdown === "access" ? "rotate-0" : "rotate-180"}`} />
                            ...
                            <div className={`dropdown-menu flex-col gap-1 overflow-hidden transition-all duration-300 group-[.sidebar-collapsed]/sidebar:hidden! pl-6 ${openDropdown === "access" ? "flex" : "hidden"}`}>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("user-management"); }} className={getSubMenuLinkClass("user-management")}>
                                ...
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("doc-verification"); }} className={getSubMenuLinkClass("doc-verification")}>
                        ...
                        <div className="relative border-t border-white/20">
                            <button onClick={() => handleDropdownClick("academic")} className="w-full flex items-center justify-between py-3 px-4 transition-all duration-300 ease-out hover:bg-white/8 focus:bg-white/8 text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                                <div className="flex items-center gap-3 group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0">
                                    <div className="flex-col flex items-center justify-center">
                            ...
                            <div className={`dropdown-menu flex-col gap-1 overflow-hidden transition-all duration-300 group-[.sidebar-collapsed]/sidebar:hidden! pl-6 ${openDropdown === "academic" ? "flex" : "hidden"}`}>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("academic-config"); }} className={getSubMenuLinkClass("academic-config")}>
                                ...
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("attendance-oversight"); }} className={getSubMenuLinkClass("attendance-oversight")}>
                                ...
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("exam-cell"); }} className={getSubMenuLinkClass("exam-cell")}>
                                    <FileSpreadsheet className="w-4 h-4 text-emerald-300" />
                                    <span className="nav-text font-medium text-sm whitespace-nowrap">Examination Cell</span>
                                </a>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("academic-calendar"); }} className={getSubMenuLinkClass("academic-calendar")}>
                        ...
                        <div className="relative border-t border-white/20">
                            <button onClick={() => handleDropdownClick("finance")} className="w-full flex items-center justify-between py-3 px-4 transition-all duration-300 ease-out hover:bg-white/8 focus:bg-white/8 text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                                <div className="flex items-center gap-3 group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0">
                                    <div className="flex-col flex items-center justify-center">
                                ...
                                <ChevronDown className={`w-4 h-4 transition-transform duration-300 group-[.sidebar-collapsed]/sidebar:hidden chevron-icon mr-4 ${openDropdown === "finance" ? "rotate-0" : "rotate-180"}`} />
                            ...
                            <div className={`dropdown-menu flex-col gap-1 overflow-hidden transition-all duration-300 group-[.sidebar-collapsed]/sidebar:hidden! pl-6 ${openDropdown === "finance" ? "flex" : "hidden"}`}>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("financial-hub"); }} className={getSubMenuLinkClass("financial-hub")}>
                                    <Wallet className="w-4 h-4 text-amber-300" />
                                    <span className="nav-text font-medium text-sm whitespace-nowrap">Financial Hub</span>
                                </a>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("transport-logistics"); }} className={getSubMenuLinkClass("transport-logistics")}>
                        ...
                        <div className="relative border-t border-white/20">
                            <button onClick={() => handleDropdownClick("communication")} className="w-full flex items-center justify-between py-3 px-4 transition-all duration-300 ease-out hover:bg-white/8 focus:bg-white/8 text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                                <div className="flex items-center gap-3 group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0">
                                    <div className="flex-col flex items-center justify-center">
                                ...
                                <ChevronDown className={`w-4 h-4 transition-transform duration-300 group-[.sidebar-collapsed]/sidebar:hidden chevron-icon mr-4 ${openDropdown === "communication" ? "rotate-0" : "rotate-180"}`} />
                            ...
                            <div className={`dropdown-menu flex-col gap-1 overflow-hidden transition-all duration-300 group-[.sidebar-collapsed]/sidebar:hidden! pl-6 ${openDropdown === "communication" ? "flex" : "hidden"}`}>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("comm-center"); }} className={getSubMenuLinkClass("comm-center")}>
                        ...
                        <div className="relative border-t border-white/20">
                            <button onClick={() => handleDropdownClick("system")} className="w-full flex items-center justify-between py-3 px-4 transition-all duration-300 ease-out hover:bg-white/8 focus:bg-white/8 text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                                <div className="flex items-center gap-3 group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0">
                                    <div className="flex-col flex items-center justify-center">
                                ...
                                <ChevronDown className={`w-4 h-4 transition-transform duration-300 group-[.sidebar-collapsed]/sidebar:hidden chevron-icon mr-4 ${openDropdown === "system" ? "rotate-0" : "rotate-180"}`} />
                            ...
                            <div className={`dropdown-menu flex-col gap-1 overflow-hidden transition-all duration-300 group-[.sidebar-collapsed]/sidebar:hidden! pl-6 ${openDropdown === "system" ? "flex" : "hidden"}`}>
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("workflows"); }} className={getSubMenuLinkClass("workflows")}>
                                ...
                                <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("system-logs"); }} className={getSubMenuLinkClass("system-logs")}>
                    ...
                    <div className="p-2 group-[.sidebar-collapsed]/sidebar:pb-12 border-t border-white/20 shrink-0 relative z-50">
                        {/* Change Password */}
                        <a href="#" onClick={(e) => { e.preventDefault(); setActiveMenu("password"); }} className={`flex items-center gap-3 px-3 py-2.5 group-[.sidebar-collapsed]/sidebar:py-2 mx-2 group-[.sidebar-collapsed]/sidebar:mx-0 rounded-xl transition-all duration-300 ease-out hover:bg-emerald-500 hover:shadow-lg text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center ${activeMenu === "password" ? "bg-emerald-500 shadow-lg" : ""}`}>
                            <div className="flex-col flex items-center justify-center">
                        ...
                        {/* Sign Out */}
                        <a href="#" className="flex mt-1 items-center gap-3 px-3 py-2.5 group-[.sidebar-collapsed]/sidebar:py-2 mx-2 group-[.sidebar-collapsed]/sidebar:mx-0 rounded-xl transition-all duration-300 ease-out hover:bg-red-500/80 text-white group relative group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-0 group-[.sidebar-collapsed]/sidebar:justify-center">
                            <div className="flex-col flex items-center justify-center">
